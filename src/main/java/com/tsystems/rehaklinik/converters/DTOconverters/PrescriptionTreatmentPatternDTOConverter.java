...
public class PrescriptionTreatmentPatternDTOConverter {
    ...
    public static Prescription convertFromDTO(Prescription prescriptionToEdit, PrescriptionTreatmentPatternDTO prescriptionTreatmentPatternDTO) {
        ...
        prescriptionToEdit.getTreatmentTimePattern().setIntervalInHours(prescriptionTreatmentPatternDTO.getIntervalInHours());
