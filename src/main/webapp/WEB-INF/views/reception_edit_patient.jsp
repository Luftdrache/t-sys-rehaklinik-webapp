            ...
            <div content="container" class="col-sm-8 col-sm-offset-2"
                ...
                <form:form action="${pageContext.request.contextPath}/reception/edit" method="post"
                    ...
                    <c:if test="${empty patientMessage}">
                            ...
                            <div class="col-sm-5">
                                <select id="gender" name="gender" velue="${patientToEdit.gender}"
                                    ...
                                    <c:forEach items="${Gender.values()}" var="gen">
                                        <c:if test="${gen ne patientToEdit.gender}">
                                            <option>${gen.toString()}</option>
                                        </c:if>
                                    </c:forEach>
                                    <option selected>${patientToEdit.gender.toString()}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="phoneNumber" name="phoneNumber"
                                       value="${patientToEdit.phoneNumber}"
                        ...
                        <div class="form-group">
                            <label for="insurancePolicyCode" class="col-sm-4 control-label">Insurance Policy
                                Code*</label>
                            <div class="col-sm-5">
                                <input type="text" id="insurancePolicyCode" value="${patientToEdit.insurancePolicyCode}"
                                       placeholder="Insurance Policy Code" name="insurancePolicyCode"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="username"
                                       value="${patientToEdit.authenticationDataPatient.username}"
