            ...
            <ul>
                ...
                <c:if test="${docId eq attendingDoctorId}">
                    <li class="item" id="add-prescription" style="font-size: 20px;">
                        <a href="${pageContext.request.contextPath}/doctor/add-prescription/${prescriptionToEdit.patientId}"
                           class="menu-btn">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="administeringMedicationMethod"
                                       ...
                                       placeholder="Administering Medication Method"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <c:choose>
                                    <c:when test="${prescriptionToEdit.tuesday == true}">
                                        <input type="checkbox" id="tuesday" checked name="tuesday"
                                               placeholder="Tuesday">
                                    </c:when>
                                    <c:otherwise>
                            ...
                            <div class="col-sm-6">
                                <c:choose>
                                    <c:when test="${prescriptionToEdit.thursday == true}">
                                        <input type="checkbox" id="thursday" checked name="thursday"
                            ...
                            <div class="col-sm-6">
                                <c:choose>
                                    <c:when test="${prescriptionToEdit.saturday == true}">
                                        <input type="checkbox" id="saturday" checked name="saturday"
                            ...
                            <div class="col-sm-6">
                                <c:choose>
                                    <c:when test="${prescriptionToEdit.atMeals == true}">
                                        <input type="checkbox" id="atMeals" checked name="atMeals"
                                               placeholder="At Meals">
                                    </c:when>
                                    <c:otherwise>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <input type="checkbox" id="afterMeals" name="afterMeals"
                                               placeholder="After Meals">
                                    </c:otherwise>
                                </c:choose>
                            </div>
